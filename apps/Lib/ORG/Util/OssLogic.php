<?php
Vendor("aliyun-oss-php-sdk.src.OSS.OssClient");
Vendor("aliyun-oss-php-sdk.src.OSS.Core.OssException");
...
class OssLogic
{
    ...
    static private $accessKeyId = 'LTAIOwa5a7kVAMvg';
    static private $accessKeySecret = 'pGDRRYGFkJndj3vFNA4RJKlmIexZVT';
    static private $endpoint = 'oss-cn-beijing.aliyuncs.com';
    static private $bucket = '949381760hpf';

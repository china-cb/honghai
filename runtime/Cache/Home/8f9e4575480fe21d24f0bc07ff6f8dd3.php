    ...
    <div class="container" style="margin-bottom: 20px;">
        <div class="row">
            <div class="col-xs-12 col-sm-8 col-md-8">
                <div class="newsBox">
                    <?php
 $_result=M("Article")->field("id,catid,url,title,title_style,keywords,description,thumb,createtime")->where("createtime<=1532014256 AND status=1  AND catid in(5,11,52,12,13) AND posid like '%-1-%'")->order("id desc")->limit("1")->select(); if ($_result) { $i=0; $total = count($_result); foreach($_result as $key=>$r) { ++$i; $mod = ($i % 2 ); ?><div class="titleBar">
                            <h5>
                                热点新闻
                            </h5>
                            <span>
